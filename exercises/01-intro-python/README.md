...
Goal
- Use AI assistance to generate a function that formats a 
friendly greeting.
- Learn how to review, run, and test AI-generated code.

Instructions
1. Open `starter.py` in VS Code.
2. Use Copilot (or another AI tool) to suggest a function 
`greet(name: str) -> str` that returns `"Hello, <name>!"`.
3. Review the suggestion, accept or edit, then run `python -m 
...
venv && source .venv/bin/activate` (or Windows equivalent)
